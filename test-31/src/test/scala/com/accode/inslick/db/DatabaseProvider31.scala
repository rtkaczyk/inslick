...
class DatabaseProvider31(configPath: String) extends DatabaseProvider {
...
object DatabaseProvider31 extends DatabaseProvider.Factory {
  def apply(path: String) = new DatabaseProvider31(path)
}
